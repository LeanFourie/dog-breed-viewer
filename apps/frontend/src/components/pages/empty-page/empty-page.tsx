...
import css from './empty-page.module.scss'
...
function UiEmptyPage() {
    const name = `UiEmptyPage`
        ...
        <div className={css[name]}>
            ...
            <div className={css[`${name}__content`]}>
                <UiText size={'sm'} variant={'h4'} weight={'semi-bold'}>
                    Nothing to see here (ಥ﹏ಥ)
                </UiText>
                <UiText size={'sm'}>
                    Please go back to the home page to start exploring.
                </UiText>
                <UiButton
                    className={css[`${name}__content-cta`]}
                    color={'invert'}
                    label={'Go home'}
                    shade={'light'}
                    tag={'link'}
